...
import (
	...
	"github.com/sky-big/kubernetes-crd-controller/pkg/client/clientset/versioned/scheme"
...
func (c *ExampleV1alpha1Client) CRD1s(namespace string) CRD1Interface {
	return newCRD1s(c, namespace)
}

func (c *ExampleV1alpha1Client) CRD2s(namespace string) CRD2Interface {
	return newCRD2s(c, namespace)
}
