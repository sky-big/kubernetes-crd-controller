...
import (
	...
	crd2 "github.com/sky-big/kubernetes-crd-controller/pkg/client/injection/informers/example/v1/crd2"
...
func withInformer(ctx context.Context) (context.Context, controller.Informer) {
	...
	return context.WithValue(ctx, crd2.Key{}, inf), inf.Informer()
}
