...
type CRD1Lister interface {
	...
	List(selector labels.Selector) (ret []*v1.CRD1, err error)
...
// List lists all CRD1s in the indexer.
func (s *cRD1Lister) List(selector labels.Selector) (ret []*v1.CRD1, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1.CRD1))
	})
	return ret, err
}
...
// List lists all CRD1s in the indexer for a given namespace.
func (s cRD1NamespaceLister) List(selector labels.Selector) (ret []*v1.CRD1, err error) {
...
// Get retrieves the CRD1 from the indexer for a given namespace and name.
func (s cRD1NamespaceLister) Get(name string) (*v1.CRD1, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("crd1"), name)
	}
	return obj.(*v1.CRD1), nil
}
