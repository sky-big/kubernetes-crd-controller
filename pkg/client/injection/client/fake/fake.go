...
import (
	...
	fake "github.com/sky-big/kubernetes-crd-controller/pkg/client/clientset/versioned/fake"
	client "github.com/sky-big/kubernetes-crd-controller/pkg/client/injection/client"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/sky-big/kubernetes-crd-controller/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
